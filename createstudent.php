...
include_once("createStudentSQL.php");

$firstNameError = $lastNameError = $courseError = $emailError = "";
$allFieldsValid = true;
                ...
                <div class="card" style="background-color: #D90B3E;">
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label labelFont" style="color: white;">email</label>
                                <input class="form-control" type="text" name="email" style="background-color: white;">
                                <span class="text-danger" style="color: white;"><?php echo $emailError; ?></span>
                            </div>
